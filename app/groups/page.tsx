...
export default function GroupsPage() {
  ...
  const [sortBy, setSortBy] = useState<"members" | "az" | "za">("members");
                ...
                {(() => {
                  const filteredAndSortedGuilds = (() => {
                    ...
                    return [...filtered].sort((a, b) => {
                      ...
                      return parseMembers(b.members) - parseMembers(a.members);
                    });
                  })();
                      ...
                      <div className="flex items-center justify-between border-b border-[#1f2937] pb-3">
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-xs text-slate-400">
                            {filteredAndSortedGuilds.length} results
                          </span>
                          <div className="flex items-center bg-[#1e293b] p-0.5 rounded-lg border border-[#334155] text-xs">
                            <button
                              type="button"
                              onClick={() => setSortBy("members")}
                              className={`px-2 py-0.5 rounded text-[11px] font-medium transition cursor-pointer ${
                                sortBy === "members" ? "bg-blue-600 text-white" : "text-slate-400 hover:text-white"
                              }`}
                              title="Sort by Popularity / Members"
                            >
                              Popular
                            </button>
                            <button
                              ...
                              className={`px-2 py-0.5 rounded text-[11px] font-medium transition cursor-pointer ${
                                sortBy === "az" ? "bg-blue-600 text-white" : "text-slate-400 hover:text-white"
                              }`}
